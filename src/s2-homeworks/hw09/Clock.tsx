...
function Clock() {
    ...
    function getCurrentDate() {
        ...
        const month = (date.getMonth() + 1).toString().padStart(2, '0'); // Месяцы в объекте Date начинаются с 0
        const year = date.getFullYear();

        return `${day}.${month}.${year}`;
    }

    const stringTime = getCurrentTime() // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const stringDate = getCurrentDate() // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
